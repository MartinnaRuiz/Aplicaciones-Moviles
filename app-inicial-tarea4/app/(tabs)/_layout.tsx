  ...
  return (
    ...
    >
      ...
      />
       <Tabs.Screen
        ...
        options={{
          title: 'Contador',
          tabBarIcon: ({ focused, size }) => (
            <Ionicons name={focused ? 'calculator' : 'calculator-outline'} size={size} color={icon_color} />
          ),
        }}
      />
      ...
      options={{ 
        ...
        <Tabs.Screen name="galeriaScreen" 
      options={{ 
        title: 'Galeria',
        tabBarIcon: ({focused,size}) => (
          <Ionicons name={focused ? 'images' : 'images-outline'} size={size} color={icon_color} />
        )
